...
urlpatterns = [
    ...
    url(r'^create/(?P<contentId>\d+)/$',
        createView, name='h5pedit'),

    # Users score
    url(r'^score/(?P<contentId>\d+)/$',
        scoreView, name='h5pscore'),
    ...
    url(r'^editorajax/(?P<contentId>\d+)/$',
        editorAjax, name='h5peditorAjax'),
]
